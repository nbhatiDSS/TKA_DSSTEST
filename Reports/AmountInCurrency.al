...
//                             "G/L Entry_Temp".SetFilter("Batch ID", '%', GetCompanyShortName(Company.Name)); //State code used for company 
//                             if "G/L Entry_Temp".FindFirst() then begin
//                                 "G/L Entry_temp".Amount += "G/L Entry".Amount;
//                                 "G/L Entry_Temp"."Original Amount (Custom)" += Round(ConvertToGBP("G/L Entry".CurrentCompany, "G/L Entry".Amount, ToDate, CurrencyCode), 1, '=');
...
//                                     "G/L Entry_Temp"."Original Amount (Custom)" := Round(ConvertToGBP("G/L Account1".CurrentCompany, "G/L Entry".Amount, ToDate, CurrencyCode), 1, '=');
...
//                                     "G/L Entry_Temp"."Batch ID" := GetCompanyShortName("G/L Entry".CurrentCompany); //For current company
