page 70084 "Card Save 1"
{
        ...
        area(content)
        {
            ...
            repeater(repeater)
            {
                ...
                field(Amount; rec.Amount)
                {
                    ...
                    Editable = false;
                    Style = Attention;
                    StyleExpr = Rec.Amount <> Rec."Total Sales Amount";
                }
    ...
    var
        lToDO: Record "5080";
    begin
        // StyleAmount := rec.Amount = rec."Total Sales Amount";
            ...
            REPEAT
                ...
                if GlobalIRIS.FindFirst() then begin
                    ...
                    IF SalesInvoiceHeader1.FIND('-') THEN BEGIN
                        ...
                        "Sales Order PAS Auto Post".CreatePaymentEntryINDIA("CardSave Import Buffer9", SalesInvoiceHeader1);
                    END;
                end;
